        ...
        {items.map((post, index) => (
          ...
          >
            <a
              ...
              className="flex flex-col justify-between border-t border-t-slate-100 py-10  text-black-happiier md:flex-row "
            ...
            >
              ...
              <span className="ml-auto flex items-center gap-1 text-xl font-medium md:ml-0 mt-8 md:mt-0">
